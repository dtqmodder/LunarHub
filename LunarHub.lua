...
object.LunarHub = instance.new("ScreenGui", {
    Name = "d t q";
    Parent = game.CoreGui;
...
-- Loaded UI Hub?local LoadedUiHub 
        ...
        RandomText = {
            ...
            "Cause i Need someone to believe in love"
            " Copyright by @dtqmodder_09 "
        }
        ...
        function Window:NewTab(dtq)
            local domain
            newmm = Window:AddTab(dtq)
            domain = newmm
            function newmm:NewParagraph(cf)
                local paragraphnew
                newTitle = cf.Title or "LunarHub"
                newContent = cf.Content or "DTQ"
                paragraphnew =
                    domain:AddParagraph(
                    {
                        Content = newContent,
                ...
                function paragraphnew:Set(cf2)
                    newTitle = cf2.Title or "Lunar Hub"
                    newContent = cf2.Content or "Lunar"
        ...
        -- Main -- /copyright by dtqmodder_09
        ...
        function CreateUiNotify(cf)
            newtitle = cf.Title or "Lunar Hub"
