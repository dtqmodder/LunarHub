...
function CheckQuest() 
    ...
    if World1 then
        if MyLevel == 1 or MyLevel <= 9 then
            ...
            NameMon = "Bandit"
            CFrameQuest = CFrame.new(1049.37195, 15.4495068, 1550.4231, 0.939700544, -0, -0.341998369, 0, 1, -0, 0.341998369, 0, 0.939700544)
            CFrameMon = CFrame.new(1043.962646484375, 28.00250816345215, 1560.8203125)
...
spawn(function() 
    ...
    wait(.24)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Tham gia telegram để cập nhật thông tin mới nhất nhé<Color=/>"):Display()
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Green>YT : @dtqmodder_09 <Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Lunar Hub", HidePremium = false, IntroText = "LunarHub Library", SaveConfig = true, ConfigFolder = "Lunar Hub"})

OrionLib:MakeNotification({
	Name = "Lunar Hub",
	Content = "Chọn Team nào người anh em?",
	Image = "rbxassetid://88977940117252",
	Time = 7
})

OrionLib:MakeNotification({
	Name = "Lunar Hub",
	Content = "Lunar Hub @dtqmodder_09",
	Image = "rbxassetid://88977940117252",
	Time = 25
})
...
local W = Window:MakeTab({
    Name = "👋 Welcome",
    Icon = "rbxassetid://88977940117252",
    PremiumOnly = false
})
...
local ST = Window:MakeTab({
    Name = "🛠️ Setting",
    Icon = "rbxassetid://137632680493297",
    PremiumOnly = false
})
...
W:AddLabel("Script by @dtqmodder_09")

local Section = W:AddSection({
    Name = "Update"
})

W:AddLabel("[+] Lunar Hub is back!")
W:AddLabel("[+] Version : Beta 1.0")
W:AddLabel("[+] Welcome to Lunar Hub!!!")
